...
/**
 * Type Annotation on a Type Parameter: A "Type Annotation" is an annotation
 * which can be used with the types e.g. return type of a method, the type of
 * "this" within a method, a cast, array levels, an inherited class, a throws
 * clause.
 * 
 * @author Sumon Dey
 *
